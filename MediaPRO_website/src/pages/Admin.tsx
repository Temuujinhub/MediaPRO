...
const Admin = () => {
  ...
  useEffect(() => {
    if (!sessionStorage.getItem('admin_auth')) navigate('/admin/login');
  }, []);
  ...
  const cards = [
    {
      title: 'Portfolio',
      description: 'Add, edit, and delete projects. Upload screenshots for each project.',
    ...
    {
      title: 'Team Members',
      description: 'Manage team member profiles, photos, and roles.',
    ...
    <div className="min-h-screen bg-slate-950 text-white">
        ...
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-slate-400 text-xs">Management Dashboard</div>
            </div>
          </div>
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        <div className="mb-10">
          ...
          <p className="text-slate-400">Manage your website content from here.</p>
        </div>
        ...
        <div className="bg-slate-900 rounded-2xl border border-slate-800 p-6">
          <h3 className="font-semibold mb-3 text-sm text-slate-300">Supabase Configuration</h3>
          <div className="space-y-2 text-xs text-slate-500">
            <p>Set the following environment variables in GitHub Secrets to enable the backend:</p>
            <div className="bg-slate-800 rounded-lg p-3 font-mono space-y-1 text-slate-300">
              ...
              <div>VITE_ADMIN_PASSWORD=your_password</div>
            </div>
            <p className="pt-1">
              Create <code className="text-blue-400">portfolio_items</code> and{' '}
              <code className="text-blue-400">team_members</code> tables using the migration SQL file.
            </p>
          </div>
        </div>
      </div>

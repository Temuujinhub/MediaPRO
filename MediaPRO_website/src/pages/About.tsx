          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <Card className="corporate-shadow hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-8 text-center">
                <div className="w-32 h-32 mx-auto mb-6 rounded-full overflow-hidden bg-gray-200">
                  <img 
                    src="https://static-us-img.skywork.ai/prod/nexus/1765427669/cropped_image_0_1765427669677372639.jpg" 
                    alt="CEO Angarag.S" 
            ...
            <Card className="corporate-shadow hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-8 text-center">
                <div className="w-32 h-32 mx-auto mb-6 rounded-full overflow-hidden bg-gray-200">
                  <img 
                    src="https://static-us-img.skywork.ai/prod/nexus/1765427669/cropped_image_14_1765427669704775977.jpg" 
            ...
            <Card className="corporate-shadow hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-8 text-center">
                <div className="w-32 h-32 mx-auto mb-6 rounded-full overflow-hidden bg-gray-200">
                  <img 
                    src="https://static-us-img.skywork.ai/prod/nexus/1765427669/cropped_image_6_1765427669688922044.jpg" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <Card className="corporate-shadow hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-6 text-center">
                <div className="w-24 h-24 mx-auto mb-4 rounded-full overflow-hidden bg-gray-200">
                  <img 
                    src="https://static-us-img.skywork.ai/prod/nexus/1765427669/cropped_image_8_1765427669692710963.jpg" 
            ...
            <Card className="corporate-shadow hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-6 text-center">
                <div className="w-24 h-24 mx-auto mb-4 rounded-full overflow-hidden bg-gray-200">
                  <img 
                    src="https://static-us-img.skywork.ai/prod/nexus/1765427669/cropped_image_2_1765427669680963954.jpg" 
            ...
            <Card className="corporate-shadow hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-6 text-center">
                <div className="w-24 h-24 mx-auto mb-4 rounded-full overflow-hidden bg-gray-200">
                  <img 
                    src="https://static-us-img.skywork.ai/prod/nexus/1765427669/cropped_image_18_1765427669712722200.jpg" 

...
const Solutions = () => {
  const solutions = [
    ...
    },
    {
      ...
      description: 'Built for Mongolia\'s vast territory and demanding industrial environments — our Fleex.mn and Flux.mn platforms unify fleet telematics, transport routing, and fuel distribution into one mission-critical operational layer. Trusted to keep mining, logistics, and energy operations moving 24/7 across the country.',
      icon: <Truck className="h-8 w-8" />,
      features: [
        'Fleex.mn — real-time GPS fleet intelligence, driver telematics, and predictive maintenance',
        'Flux.mn — comprehensive fuel distribution station management and corporate fuel-card programs',
        'Geofencing, route deviation alerts, and high-load multi-organization architecture',
        'Anomaly detection and fuel-loss prevention across distributed station networks',
        'Native QPay, SocialPay, and Monpay integration at the pump and inside the fleet dashboard',
        'Unified analytics linking vehicle utilization, fuel consumption, and route efficiency',
        'Engineered for industrial-scale partners across mining, telecom, and multi-sector groups',
      ],
      examples: [
        'Fleex.mn — Fleet Flexibility platform for enterprise vehicle operations',
        'Flux.mn — Fuel Flux digital ecosystem for fuel distribution stations',
      ],
      color: 'blue',
    },
    {
